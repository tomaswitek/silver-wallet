 ...
 */
export function getConsensusParametersByNetwork(
  network: NetworkType,
): ConsensusParams;
 ...
 * @returns {ConsensusParams}
 */
export function getConsensusParametersByAddress(
  address: Address,
): ConsensusParams;
...
export type IUtxoProcessorEvent = {
  [K in keyof UtxoProcessorEventMap]: {
    event: K;
...
export interface InitOutput {
  ...
  readonly masscalculator_isTransactionOutputDust: (
    a: number,
    b: number,
  ) => void;
  readonly masscalculator_minimumRelayTransactionFee: () => number;
  readonly masscalculator_maximumStandardTransactionMass: () => number;
  readonly masscalculator_minimumRequiredTransactionRelayFee: (
    a: number,
  ) => number;
  readonly masscalculator_calcMassForTransaction: (
    a: number,
    b: number,
    c: number,
  ) => void;
  ...
  readonly masscalculator_calcMassForOutputs: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly masscalculator_calcMassForInputs: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly masscalculator_calcMassForOutput: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly masscalculator_calcMassForInput: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly masscalculator_calcSignatureMass: (a: number, b: number) => number;
  readonly masscalculator_calcSignatureMassForInputs: (
    a: number,
    b: number,
    c: number,
  ) => number;
  readonly masscalculator_calcMinimumTransactionRelayFeeFromMass: (
    a: number,
    b: number,
  ) => number;
  readonly masscalculator_calcMiniumTxRelayFee: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly __wbg_set_nodedescriptor_id: (
    a: number,
    b: number,
    c: number,
  ) => void;
  ...
  readonly __wbg_get_nodedescriptor_provider_name: (
    a: number,
    b: number,
  ) => void;
  readonly __wbg_set_nodedescriptor_provider_name: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly __wbg_get_nodedescriptor_provider_url: (
    a: number,
    b: number,
  ) => void;
  readonly __wbg_set_nodedescriptor_provider_url: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly __wbg_pow_free: (a: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h8a39f97c45b66eb5: (
    a: number,
    b: number,
  ) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he207a4d744e23aaa: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly _dyn_core__ops__function__FnMut__A_B___Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4fcf0ff2bd4d0451: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => number;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3ab98d36cc07bb24: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h157135bb305edcba: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h048a2b7c6a5bcd30: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h536d4da9a2de3155: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hcd41749ffaf9b105: (
    a: number,
    b: number,
  ) => void;
  readonly _dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbc5fa08bd8e61ccd: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd51b775d844bf3c0: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly wasm_bindgen__convert__closures__invoke2_mut__h0960375cf53849aa: (
    a: number,
    b: number,
    c: number,
    d: number,
